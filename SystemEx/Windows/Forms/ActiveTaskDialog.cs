...
namespace SystemEx.Windows.Forms
{
    ...
    public class ActiveTaskDialog : IWin32Window
    {
        ...
        ////        this.windowHandle,
        ////        (uint)Win32.NativeMethods.TASKDIALOG_MESSAGES.TDM_NAVIGATE_PAGE,
        ////        IntPtr.Zero,
        ////        //a Win32.NativeMethods.TASKDIALOGCONFIG value);
        ////}
        ...
        public bool ClickButton ( int buttonId )
        {
            ...
            return Win32.NativeMethods.SendMessage (
                this.handle,
                (uint)Win32.NativeMethods.TASKDIALOG_MESSAGES.TDM_CLICK_BUTTON,
                (IntPtr)buttonId,
        ...
        public bool SetMarqueeProgressBar ( bool marquee )
        {
            ...
            return Win32.NativeMethods.SendMessage (
                this.handle,
                (uint)Win32.NativeMethods.TASKDIALOG_MESSAGES.TDM_SET_MARQUEE_PROGRESS_BAR,
        ...
        public bool SetProgressBarState ( ProgressBarState newState )
        {
            ...
            return Win32.NativeMethods.SendMessage (
                this.handle,
                (uint)Win32.NativeMethods.TASKDIALOG_MESSAGES.TDM_SET_PROGRESS_BAR_STATE,
                (IntPtr)newState,
                IntPtr.Zero ) != IntPtr.Zero;
        ...
        public bool SetProgressBarRange ( Int16 minRange, Int16 maxRange )
        {
            ...
            return Win32.NativeMethods.SendMessage (
                this.handle,
                (uint)Win32.NativeMethods.TASKDIALOG_MESSAGES.TDM_SET_PROGRESS_BAR_RANGE,
                IntPtr.Zero,
                lparam ) != IntPtr.Zero;
        ...
        public int SetProgressBarPosition ( int newPosition )
        {
            ...
            return (int)Win32.NativeMethods.SendMessage (
                this.handle,
                (uint)Win32.NativeMethods.TASKDIALOG_MESSAGES.TDM_SET_PROGRESS_BAR_POS,
                (IntPtr)newPosition,
                IntPtr.Zero );
        }
        ...
        public void SetProgressBarMarquee ( bool startMarquee, uint speed )
        {
            ...
            Win32.NativeMethods.SendMessage (
                this.handle,
                (uint)Win32.NativeMethods.TASKDIALOG_MESSAGES.TDM_SET_PROGRESS_BAR_MARQUEE,
        ...
        public bool SetContent ( string content )
        {
            ...
            return Win32.NativeMethods.SendMessageWithString (
                this.handle,
                (uint)Win32.NativeMethods.TASKDIALOG_MESSAGES.TDM_SET_ELEMENT_TEXT,
                (IntPtr)Win32.NativeMethods.TASKDIALOG_ELEMENTS.TDE_CONTENT,
                content ) != IntPtr.Zero;
        }
        ...
        public bool SetExpandedInformation ( string expandedInformation )
        {
            ...
            return Win32.NativeMethods.SendMessageWithString (
                this.handle,
                (uint)Win32.NativeMethods.TASKDIALOG_MESSAGES.TDM_SET_ELEMENT_TEXT,
                (IntPtr)Win32.NativeMethods.TASKDIALOG_ELEMENTS.TDE_EXPANDED_INFORMATION,
        ...
        public bool SetFooter ( string footer )
        {
            ...
            return Win32.NativeMethods.SendMessageWithString (
                this.handle,
                (uint)Win32.NativeMethods.TASKDIALOG_MESSAGES.TDM_SET_ELEMENT_TEXT,
                (IntPtr)Win32.NativeMethods.TASKDIALOG_ELEMENTS.TDE_FOOTER,
                footer ) != IntPtr.Zero;
        }
        ...
        public bool SetMainInstruction ( string mainInstruction )
        {
            ...
            return Win32.NativeMethods.SendMessageWithString (
                this.handle,
                (uint)Win32.NativeMethods.TASKDIALOG_MESSAGES.TDM_SET_ELEMENT_TEXT,
                (IntPtr)Win32.NativeMethods.TASKDIALOG_ELEMENTS.TDE_MAIN_INSTRUCTION,
        ...
        public void ClickRadioButton ( int buttonId )
        {
            ...
            Win32.NativeMethods.SendMessage (
                this.handle,
                (uint)Win32.NativeMethods.TASKDIALOG_MESSAGES.TDM_CLICK_RADIO_BUTTON,
                (IntPtr)buttonId,
                IntPtr.Zero );
        }
        ...
        public void EnableButton ( int buttonId, bool enable )
        {
            ...
            Win32.NativeMethods.SendMessage (
                this.handle,
                (uint)Win32.NativeMethods.TASKDIALOG_MESSAGES.TDM_ENABLE_BUTTON,
                (IntPtr)buttonId,
                (IntPtr)( enable ? 0 : 1 ) );
        }
        ...
        public void EnableRadioButton ( int buttonId, bool enable )
        {
            ...
            Win32.NativeMethods.SendMessage (
                this.handle,
                (uint)Win32.NativeMethods.TASKDIALOG_MESSAGES.TDM_ENABLE_RADIO_BUTTON,
                (IntPtr)buttonId,
                (IntPtr)( enable ? 0 : 1 ) );
        }
        ...
        public void ClickVerification ( bool checkedState, bool setKeyboardFocusToCheckBox )
        {
            ...
            Win32.NativeMethods.SendMessage (
                this.handle,
                (uint)Win32.NativeMethods.TASKDIALOG_MESSAGES.TDM_CLICK_VERIFICATION,
        ...
        public void UpdateContent ( string content )
        {
            ...
            Win32.NativeMethods.SendMessageWithString (
                this.handle,
                (uint)Win32.NativeMethods.TASKDIALOG_MESSAGES.TDM_UPDATE_ELEMENT_TEXT,
                (IntPtr)Win32.NativeMethods.TASKDIALOG_ELEMENTS.TDE_CONTENT,
                content );
        }
        ...
        public void SetButtonElevationRequiredState ( int buttonId, bool elevationRequired )
        {
            ...
            Win32.NativeMethods.SendMessage (
                this.handle,
                (uint)Win32.NativeMethods.TASKDIALOG_MESSAGES.TDM_SET_BUTTON_ELEVATION_REQUIRED_STATE,
                (IntPtr)buttonId,
        ...
        public void UpdateMainIcon ( TaskDialogIcon icon )
        {
            ...
            Win32.NativeMethods.SendMessage (
                this.handle,
                (uint)Win32.NativeMethods.TASKDIALOG_MESSAGES.TDM_UPDATE_ICON,
                (IntPtr)Win32.NativeMethods.TASKDIALOG_ICON_ELEMENTS.TDIE_ICON_MAIN,
                (IntPtr)(uint)icon );
        }
        ...
        public void UpdateFooterIcon ( TaskDialogIcon icon )
        {
            ...
            Win32.NativeMethods.SendMessage (
                this.handle,
                (uint)Win32.NativeMethods.TASKDIALOG_MESSAGES.TDM_UPDATE_ICON,
                (IntPtr)Win32.NativeMethods.TASKDIALOG_ICON_ELEMENTS.TDIE_ICON_FOOTER,
                (IntPtr)(uint)icon );
        }
