...
namespace SystemEx.Windows.Forms
{
    ...
    public class TaskDialog
    {
        ...
        /// </summary>
        private Win32.NativeMethods.TASKDIALOG_FLAGS flags;
        ...
        {
            get { return ( this.flags & Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_ENABLE_HYPERLINKS ) != 0; }
            set { this.SetFlag ( Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_ENABLE_HYPERLINKS, value ); }
        }
        ...
        {
            get { return ( this.flags & Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_ALLOW_DIALOG_CANCELLATION ) != 0; }
            set { this.SetFlag ( Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_ALLOW_DIALOG_CANCELLATION, value ); }
        }
        ...
        {
            get { return ( this.flags & Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_USE_COMMAND_LINKS ) != 0; }
            set { this.SetFlag ( Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_USE_COMMAND_LINKS, value ); }
        }
        ...
        {
            get { return ( this.flags & Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_USE_COMMAND_LINKS_NO_ICON ) != 0; }
            set { this.SetFlag ( Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_USE_COMMAND_LINKS_NO_ICON, value ); }
        }
        ...
        {
            get { return ( this.flags & Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_EXPAND_FOOTER_AREA ) != 0; }
            set { this.SetFlag ( Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_EXPAND_FOOTER_AREA, value ); }
        }
        ...
        {
            get { return ( this.flags & Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_EXPANDED_BY_DEFAULT ) != 0; }
            set { this.SetFlag ( Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_EXPANDED_BY_DEFAULT, value ); }
        }
        ...
        {
            get { return ( this.flags & Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_VERIFICATION_FLAG_CHECKED ) != 0; }
            set { this.SetFlag ( Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_VERIFICATION_FLAG_CHECKED, value ); }
        }
        ...
        {
            get { return ( this.flags & Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_SHOW_PROGRESS_BAR ) != 0; }
            set { this.SetFlag ( Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_SHOW_PROGRESS_BAR, value ); }
        }
        ...
        {
            get { return ( this.flags & Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_SHOW_MARQUEE_PROGRESS_BAR ) != 0; }
            set { this.SetFlag ( Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_SHOW_MARQUEE_PROGRESS_BAR, value ); }
        }
        ...
        {
            get { return ( this.flags & Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_CALLBACK_TIMER ) != 0; }
            set { this.SetFlag ( Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_CALLBACK_TIMER, value ); }
        }
        ...
        {
            get { return ( this.flags & Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_POSITION_RELATIVE_TO_WINDOW ) != 0; }
            set { this.SetFlag ( Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_POSITION_RELATIVE_TO_WINDOW, value ); }
        }
        ...
        {
            get { return ( this.flags & Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_RTL_LAYOUT ) != 0; }
            set { this.SetFlag ( Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_RTL_LAYOUT, value ); }
        }
        ...
        {
            get { return ( this.flags & Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_NO_DEFAULT_RADIO_BUTTON ) != 0; }
            set { this.SetFlag ( Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_NO_DEFAULT_RADIO_BUTTON, value ); }
        }
        ...
        {
            get { return ( this.flags & Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_CAN_BE_MINIMIZED ) != 0; }
            set { this.SetFlag ( Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_CAN_BE_MINIMIZED, value ); }
        }
        ...
        private int PrivateShow ( IntPtr hwndOwner, out bool verificationFlagChecked, out int radioButtonResult )
        {
            ...
            Win32.NativeMethods.TASKDIALOGCONFIG config = new Win32.NativeMethods.TASKDIALOGCONFIG ( );

            try
            {
                config.cbSize = (uint)Marshal.SizeOf ( typeof ( Win32.NativeMethods.TASKDIALOGCONFIG ) );
                ...
                {
                    config.dwFlags |= Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_USE_HICON_MAIN;
                ...
                {
                    config.dwFlags |= Win32.NativeMethods.TASKDIALOG_FLAGS.TDF_USE_HICON_FOOTER;
                ...
                {
                    config.pfCallback = new Win32.NativeMethods.TaskDialogCallback ( this.PrivateCallback );
                }
                ...
                using (new ActivationContext())
                {
                    ...
                    Win32.NativeMethods.TaskDialogIndirect(ref config, out result, out radioButtonResult, out verificationFlagChecked);
                }
            }
            finally
            {
